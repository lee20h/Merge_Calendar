...
namespace NaverLogin_Console
{
    class Program
    {
        static void Main(string[] args)
        {
            string sResultJson = "kmv3Gs4oyq9N1QUWhFklp37SFKdZXscuiKib8RP5IviUMMnK2n7VMhh3e5T8drqwhw8skkSAI";
            string ClientID = "zQwIkERyv2mJDHyEhtaj";
            string ClientSecret = "vMf4JX0A5K";

            string token = sResultJson;// 네이버 로그인 접근 토큰;
            ...
            string uid = (random.Next()%100).ToString();
            ...
            string scheduleIcalString = "BEGIN:VCALENDAR\n" +
                  ...
                  "TRANSP:OPAQUE\n" +
                  "UID:" + uid + "\n" +                          // 일정 고유 아이디
                  "DTSTART;TZID=Asia/Seoul:20190517T170000\n" +  // 시작 일시
                  "DTEND;TZID=Asia/Seoul:20190517T173000\n" +    // 종료 일시
                  "SUMMARY:" + calSum + " \n" +                    // 일정 제목
                  "DESCRIPTION:" + calDes + " \n" +                // 일정 상세 내용
                  "LOCATION:" + calLoc + " \n" +                   // 장소
